...
import br.com.gbaeta.dao.ClienteMapDAO;
...
import br.com.gbaeta.fabrica.FabricaPersistente;
import br.com.gbaeta.fabrica.Factory;
import br.com.gbaeta.fabrica.IFactory;
	...
	public static void main(String args[]) {
		...
		while (isOpcaoValida(opcaoMenuGeral)) {
			...
			String opcao = JOptionPane.showInputDialog(null,
					"Digite 1 para cadastro, 2 para consultar, 3 para exclusão ou 4 para sair",
